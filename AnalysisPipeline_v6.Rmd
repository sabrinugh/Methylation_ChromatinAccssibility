...
``` {r Normal methylation plotting}
featureNormalCircosValues <- function(methFeatureGR, featureName = "Feature") {
  factors <- as.character(seqnames(methFeatureGR))
  chroms <- unique(factors)
  
  # Compute xlim per chromosome based on both datasets
  xlimList <- lapply(chroms, function(chr) {
    chrRanges <- methFeatureGR[seqnames(methFeatureGR) == chr]
    c(min(start(chrRanges)), max(end(chrRanges)))
  })
  xlim <- do.call(rbind, xlimList)
  rownames(xlim) <- chroms
  ...
  # Add main title
  title(paste("Circos Plot of Normal Sample Averages of: ", featureName))
}
...
featureComparisonCircosValuesOverlay <- function(methFeatureGR, atacFeatureGR, featureName = "Feature") {
  ...
  mcols(methFeatureGR)$avgMethNorm <- normalize_minmax(mcols(methFeatureGR)$avgMeth)
  mcols(atacFeatureGR)$avgATACNorm <- normalize_minmax(mcols(atacFeatureGR)$avgATAC)
...
for (sub in subgroups) {
  for (feat in sigFeatures) {
    ...
    methResult <- methVar[methVar$geneChr == 7]
    atacResult <- atacVar[atacVar$geneChr == 7]
    
    methName <- paste0("meth", feat, "7", sub)
    atacName <- paste0("atac", feat, "7", sub)
...
for (sub in subgroups) {
  for (feat in sigFeatures) {
    ...
    methResult <- methVar[methVar$geneChr == 12]
    atacResult <- atacVar[atacVar$geneChr == 12]
    
    methName <- paste0("meth", feat, "12", sub)
    atacName <- paste0("atac", feat, "12", sub)
...
featureComparisonSubtypeOverlay(methIntrons12LumA, atacIntrons12LumA, "Introns", "LumA")
featureComparisonSubtypeOverlay(methIntrons12LumB, atacIntrons12LumB, "Introns", "LumB")
featureComparisonSubtypeOverlay(methIntrons12Basal, atacIntrons12Basal, "Introns", "Basal")
featureComparisonSubtypeOverlay(methIntrons12Normal, atacIntrons12Normal, "Introns", "Normal")
featureComparisonSubtypeOverlay(methIntrons12Her2, atacIntrons12Her2, "Introns", "Her2")

## Exons
layout(matrix(1:6, 2, 3))
featureComparisonSubtypeOverlay(methExons12LumA, atacExons12LumA, "Exons", "LumA")
featureComparisonSubtypeOverlay(methExons12LumB, atacExons12LumB, "Exons", "LumB")
featureComparisonSubtypeOverlay(methExons12Basal, atacExons12Basal, "Exons", "Basal")
featureComparisonSubtypeOverlay(methExons12Normal, atacExons12Normal, "Exons", "Normal")
featureComparisonSubtypeOverlay(methExons12Her2, atacExons12Her2, "Exons", "Her2")

## Promoters
layout(matrix(1:6, 2, 3))
featureComparisonSubtypeOverlay(methPromoters12LumA, atacPromoters12LumA, "Promoters", "LumA")
featureComparisonSubtypeOverlay(methPromoters12LumB, atacPromoters12LumB, "Promoters", "LumB")
featureComparisonSubtypeOverlay(methPromoters12Basal, atacPromoters12Basal, "Promoters","Basal")
featureComparisonSubtypeOverlay(methPromoters12Normal, atacPromoters12Normal, "Promoters", "Normal")
featureComparisonSubtypeOverlay(methPromoters12Her2, atacPromoters12Her2, "Promoters", "Her2")

## Distal intergenic
layout(matrix(1:6, 2, 3))
featureComparisonSubtypeOverlay(methDistalInt12LumA, atacDistalInt12LumA, "DistalInt", "LumA")
featureComparisonSubtypeOverlay(methDistalInt12LumB, atacDistalInt12LumB, "DistalInt", "LumB")
featureComparisonSubtypeOverlay(methDistalInt12Basal, atacDistalInt12Basal, "DistalInt", "Basal")
featureComparisonSubtypeOverlay(methDistalInt12Normal, atacDistalInt12Normal, "Distal Intergenic", "Normal")
featureComparisonSubtypeOverlay(methDistalInt12Her2, atacDistalInt12Her2, "DistalInt", "Her2")


# --------------- Chromosome 7
## Introns
layout(matrix(1:6, 2, 3))
featureComparisonSubtypeOverlay(methIntrons7LumA, atacIntrons7LumA, "Introns", "LumA")
featureComparisonSubtypeOverlay(methIntrons7LumB, atacIntrons7LumB, "Introns", "LumB")
featureComparisonSubtypeOverlay(methIntrons7Basal, atacIntrons7Basal, "Introns", "Basal")
featureComparisonSubtypeOverlay(methIntrons7Normal, atacIntrons7Normal, "Introns", "Normal")
featureComparisonSubtypeOverlay(methIntrons7Her2, atacIntrons7Her2, "Introns", "Her2")

## Exons
layout(matrix(1:6, 2, 3))
featureComparisonSubtypeOverlay(methExons7LumA, atacExons7LumA, "Exons", "LumA")
featureComparisonSubtypeOverlay(methExons7LumB, atacExons7LumB, "Exons", "LumB")
featureComparisonSubtypeOverlay(methExons7Basal, atacExons7Basal, "Exons", "Basal")
featureComparisonSubtypeOverlay(methExons7Normal, atacExons7Normal, "Exons", "Normal")
featureComparisonSubtypeOverlay(methExons7Her2, atacExons7Her2, "Exons", "Her2")


## Promoters
layout(matrix(1:6, 2, 3))
featureComparisonSubtypeOverlay(methPromoters7LumA, atacPromoters7LumA, "Promoters", "LumA")
featureComparisonSubtypeOverlay(methPromoters7LumB, atacPromoters7LumB, "Promoters","LumB")
featureComparisonSubtypeOverlay(methPromoters7Basal, atacPromoters7Basal, "Promoters", "Basal")
featureComparisonSubtypeOverlay(methPromoters7Normal, atacPromoters7Normal, "Promoters", "Normal")
featureComparisonSubtypeOverlay(methPromoters7Her2, atacPromoters7Her2, "Promoters", "Her2")


## Distal intergenic
layout(matrix(1:6, 2, 3))
featureComparisonSubtypeOverlay(methDistalInt7LumA, atacDistalInt7LumA, "DistalInt", "LumA")
featureComparisonSubtypeOverlay(methDistalInt7LumB, atacDistalInt7LumB, "DistalInt","LumB")
featureComparisonSubtypeOverlay(methDistalInt7Basal, atacDistalInt7Basal, "DistalInt", "Basal")
featureComparisonSubtypeOverlay(methDistalInt7Normal, atacDistalInt7Normal, "DistalInt", "Normal")
featureComparisonSubtypeOverlay(methDistalInt7Her2, atacDistalInt7Her2, "DistalInt", "Her2")
featureComparisonSubtypeOverlay(methDistalInt7Her2, atacDistalInt7Her2, "DistalInt Her2") # For some reason, last plot always disappears so here to act as filler
