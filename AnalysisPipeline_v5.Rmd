...
``` {r Overlaying for easier comparison}
featureComparisonCircosValuesOverlay <- function(methFeatureGR, atacFeatureGR, featureName = "Feature") {
  ...
  circos.track(
    ...
    panel.fun = function(region, value, ...) {
      ...
      atacChr <- atacFeatureGR[seqnames(atacFeatureGR) == chr]
      if (length(atacChr) > 0) {
        circos.points(start(atacChr), mcols(atacChr)$avgATACNorm, col = adjustcolor("tomato", alpha.f = 0.5), pch = 16, cex = 0.1)
      }
    },
    track.height = 0.3
  )
